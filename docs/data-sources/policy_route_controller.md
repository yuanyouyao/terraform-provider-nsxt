...
This data source provides information about Route Controller on NSX.
...
* `ha_mode` - High-availability mode for route controller.
* `virtual_network_appliance_cluster_path` - Policy path for virtual network appliance cluster.
