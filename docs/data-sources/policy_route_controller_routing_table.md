---
subcategory: "EVPN"
page_title: "NSXT: policy_route_controller_routing_table"
description: Policy route controller routing table data source.
---

# nsxt_policy_route_controller_routing_table

This data source provides the routing table and downloaded CSV routing table for a Route Controller on NSX.
...
* `routing_table` - The routing table entries from the route controller.
    * `count` - Number of route entries.
    * `error_message` - Error message if any.
    * `status` - Status of the routing table retrieval.
    ...
    * `route_entries` - List of routing entries.
        ...
        * `route_type` - Route type in routing table.
* `routing_table_csv` - The routing table in CSV format downloaded from the route controller.
