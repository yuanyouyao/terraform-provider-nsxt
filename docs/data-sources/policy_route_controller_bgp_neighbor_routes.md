---
subcategory: "EVPN"
page_title: "NSXT: policy_route_controller_bgp_neighbor_routes"
description: Policy route controller BGP Neighbor Routes data source.
---

# nsxt_policy_route_controller_bgp_neighbor_routes

This data source provides the routes received from a BGP Neighbor configured on a Route Controller in NSX.
...
```hcl
data "nsxt_policy_route_controller_bgp_neighbor_routes" "test" {
...
* `results` - List of received routes. Each item contains the following attributes:
