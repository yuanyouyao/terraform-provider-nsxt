...
func TestAccDataSourceNsxtPolicyRouteControllerBgpNeighbors_basic(t *testing.T) {
	testDataSourceName := "data.nsxt_policy_route_controller_bgp_neighbors.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNsxtPolicyRouteControllerBgpNeighborsTemplate(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(testDataSourceName, "id"),
					resource.TestCheckResourceAttrSet(testDataSourceName, "items.%"),
				),
			},
		},
	})
...
func testAccNsxtPolicyRouteControllerBgpNeighborsTemplate() string {
