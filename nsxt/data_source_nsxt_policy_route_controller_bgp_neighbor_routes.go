...
var cliRouteControllerBgpNeighborRoutesClient = infra.NewRouteControllerBgpNeighborRoutesClient

func dataSourceNsxtPolicyRouteControllerBgpNeighborRoutes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceNsxtPolicyRouteControllerBgpNeighborRoutesRead,
		...
		Schema: map[string]*schema.Schema{
			...
			"results": {
				...
				Computed:    true,
				Description: "List of neighbor routes.",
...
func dataSourceNsxtPolicyRouteControllerBgpNeighborRoutesRead(d *schema.ResourceData, m interface{}) error {
	...
	client := cliRouteControllerBgpNeighborRoutesClient(sessionContext, connector)
	if client == nil {
	...
	if err != nil {
		return fmt.Errorf("error listing BGP neighbor routes for Route Controller %s neighbor %s: %v", routeControllerID, neighborID, err)
	}
