...
func TestAccDataSourceNsxtPolicyRouteControllerInterfaceStatistics_basic(t *testing.T) {
	name := getAccTestResourceName()
	testDataSourceName := "data.nsxt_policy_route_controller_interface_statistics.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNsxtPolicyRouteControllerInterfaceStatisticsDataSourceTemplate(name),
...
func testAccNsxtPolicyRouteControllerInterfaceStatisticsDataSourceTemplate(name string) string {
