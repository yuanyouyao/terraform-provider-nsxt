...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_route_controller_bgp":                            dataSourceNsxtPolicyRouteControllerBgp(),
			"nsxt_policy_route_controller_bgp_neighbor":                   dataSourceNsxtPolicyRouteControllerBgpNeighbor(),
			"nsxt_policy_route_controller_bgp_neighbor_advertised_routes": dataSourceNsxtPolicyRouteControllerBgpNeighborAdvertisedRoutes(),
			"nsxt_policy_route_controller_bgp_neighbor_routes":            dataSourceNsxtPolicyRouteControllerBgpNeighborRoutes(),
			"nsxt_policy_route_controller_bgp_neighbors":                  dataSourceNsxtPolicyRouteControllerBgpNeighbors(),
			"nsxt_policy_route_controller_bgp_neighbors_status":           dataSourceNsxtPolicyRouteControllerBgpNeighborsStatus(),
			"nsxt_policy_route_controller_bgp_route_table":                dataSourceNsxtPolicyRouteControllerBgpRouteTable(),
			"nsxt_policy_route_controller_bgp_troubleshoot":               dataSourceNsxtPolicyRouteControllerBgpTroubleshoot(),
			"nsxt_policy_route_controller_forwarding_table":               dataSourceNsxtPolicyRouteControllerForwardingTable(),
			"nsxt_policy_route_controller_interface":                      dataSourceNsxtPolicyRouteControllerInterface(),
			"nsxt_policy_route_controller_interface_statistics":           dataSourceNsxtPolicyRouteControllerInterfaceStatistics(),
			"nsxt_policy_route_controller_interface_statistics_summary":   dataSourceNsxtPolicyRouteControllerInterfaceStatisticsSummary(),
			"nsxt_policy_route_controller_interfaces":                     dataSourceNsxtPolicyRouteControllerInterfaces(),
			"nsxt_policy_route_controller_routing_table":                  dataSourceNsxtPolicyRouteControllerRoutingTable(),
			"nsxt_policy_route_controller_state":                          dataSourceNsxtPolicyRouteControllerState(),
			"nsxt_policy_route_controllers":                               dataSourceNsxtPolicyRouteControllers(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_route_controller_bgp":                         resourceNsxtPolicyRouteControllerBgp(),
			"nsxt_policy_route_controller_bgp_neighbor":                resourceNsxtPolicyRouteControllerBgpNeighbor(),
			"nsxt_policy_route_controller_bgp_troubleshoot":            resourceNsxtPolicyRouteControllerBgpTroubleshoot(),
