...
func TestAccDataSourceNsxtPolicyRouteControllerBgpNeighborRoutes_basic(t *testing.T) {
	testDataSourceName := "data.nsxt_policy_route_controller_bgp_neighbor_routes.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNsxtPolicyRouteControllerBgpNeighborRoutesTemplate(),
...
func testAccNsxtPolicyRouteControllerBgpNeighborRoutesTemplate() string {
