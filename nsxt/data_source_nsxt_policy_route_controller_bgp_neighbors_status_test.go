...
func TestAccDataSourceNsxtPolicyRouteControllerBgpNeighborsStatus_basic(t *testing.T) {
	testDataSourceName := "data.nsxt_policy_route_controller_bgp_neighbors_status.test"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNsxtPolicyRouteControllerBgpNeighborsStatusTemplate(),
...
func testAccNsxtPolicyRouteControllerBgpNeighborsStatusTemplate() string {
