...
func TestMockDataSourceNsxtPolicyRouteControllerBgpNeighborRoutes(t *testing.T) {
	...
	mockBgpNeighRoutesSDK := bgpneighroutesmocks.NewMockRoutesClient(ctrl)
	mockWrapper := &cliinfra.RouteControllerBgpNeighborRoutesClientContext{
		Client:     mockBgpNeighRoutesSDK,
		ClientType: utl.Local,
	}

	originalCli := cliRouteControllerBgpNeighborRoutesClient
	defer func() { cliRouteControllerBgpNeighborRoutesClient = originalCli }()
	cliRouteControllerBgpNeighborRoutesClient = func(sessionContext utl.SessionContext, connector client.Connector) *cliinfra.RouteControllerBgpNeighborRoutesClientContext {
		return mockWrapper
	}
	...
	t.Run("List success", func(t *testing.T) {
		...
		ds := dataSourceNsxtPolicyRouteControllerBgpNeighborRoutes()
		...
		err := dataSourceNsxtPolicyRouteControllerBgpNeighborRoutesRead(d, m)
